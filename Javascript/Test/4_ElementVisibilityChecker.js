...
function checkElementVisibility (){
    ...
    let status = "", severity = "";
    if(isPresent === true){
        severity = (isDisplayed===true && isEnabled === true) ? "OK":"WARNING";
        if( isDisplayed===true && isEnabled === true) status = "READY";
        else if( isDisplayed===true && isEnabled === false) status = "DISABLED";
    ...
    console.log("Status: "+status+" Severity: "+severity);
}